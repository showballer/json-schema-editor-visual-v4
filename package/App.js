  ...
  render() {
    ...
    return (
      <div className="json-schema-react-editor">
        <Button style={{marginBottom:10}} className="import-json-button" type="primary" onClick={this.showModal}>
        ...
        <Row>
          ...
          <Col style={{marginTop:8,paddingTop:6}} span={this.props.showEditor ? 16 : 24} className="wrapper object-style">
            <Row gutter={10} type="flex" align="middle">
              ...
              <Col span={2} className="col-item col-item-setting">
                <span style={{marginRight:10,marginLeft:10}} className="adv-set" onClick={() => this.showAdv([], this.props.schema)}>
                  <Tooltip placement="top" title={LocalProvider('adv_setting')}>
                    <Icon style={{color:'#00a854'}} type="setting" />
                  </Tooltip>
                </span>
                {schema.type === 'object' ? (
                  <span style={{marginRight:10}} onClick={() => this.addChildField('properties')}>
                    <Tooltip placement="top" title={LocalProvider('add_child_node')}>
                      <Icon style={{color:'#2395f1'}} type="plus" className="plus" />
                    </Tooltip>
                  </span>
                ) : null}
              </Col>
