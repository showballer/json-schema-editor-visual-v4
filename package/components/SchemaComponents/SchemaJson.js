        ...
        <div className="array-type">
          <Row className="array-item-type" type="flex" justify="space-around" align="middle">
            ...
            <Col span={this.context.isMock ? 2: 3} className="col-item col-item-setting">
              <span style={{marginRight:10,marginLeft:10}} className="adv-set" onClick={this.handleShowAdv}>
              ...
              {items.type === 'object' ? (
                <span style={{marginRight:10,marginLeft:10}} onClick={this.handleAddChildField}>
        ...
        <Row gutter={10} type="flex" justify="space-around" align="middle">
          ...
          <Col span={this.context.isMock ? 2: 3}  className="col-item col-item-setting">
            ...
            <span className="delete-item" onClick={this.handleDeleteItem}>
              <Icon style={{color:'#ff561b'}} type="close" className="close" />
            </span>
            {value.type === 'object' ? (
              <DropPlus prefix={prefix} name={name} />
            ) : (
              <span style={{marginRight:10,marginLeft:10}} onClick={this.handleAddField}>
...
class SchemaObjectComponent extends Component {
  ...
  render() {
    const { data, prefix, showEdit, showAdv } = this.props;
    return (
      <div style={{paddingTop:6,marginTop:8}} className="object-style">
